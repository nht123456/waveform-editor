...
## 更新摘要
**变更内容**
- 新增曲线计算算法，支持直角和弧线两种模式
- 添加控制点计算方法，实现智能的贝塞尔曲线生成
- 新增曲线类型和曲率配置选项
- 扩展UI属性面板，支持曲线类型选择和曲率调节
...
该渲染器采用SVG技术栈，通过数学算法精确计算箭头路径，支持直角和弧线两种曲线模式，确保在复杂的时序依赖关系可视化中提供清晰、准确的视觉表达。
...
依赖箭头渲染器的核心算法基于贝塞尔曲线数学，实现了精确的路径计算和智能的控制点生成：
